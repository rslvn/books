...
public class JaxrsTest extends RepositoryTestCase {
    ...
    private static final String QUERY_TEXT = "95-8929-675-";
    ...
    public static void setupTomcat() throws LifecycleException {
        ...
        book1 = createBook(NAME_BOOK1, "authorBook1", "95-8929-675-1", ArrayUtils.toArray("introduction paragraph11", "introduction paragraph12"), ArrayUtils.toArray("book paragraph11", "book paragraph12", "book paragraph13"));
        book2 = createBook(NAME_BOOK2, "authorBook2", "95-8929-675-2", ArrayUtils.toArray("introduction paragraph21", "introduction paragraph22"), ArrayUtils.toArray("book paragraph21", "book paragraph22", "book paragraph23"));
        book3 = createBook(NAME_BOOK3, "authorBook3", "95-8929-675-3", ArrayUtils.toArray("introduction paragraph31", "introduction paragraph32"), ArrayUtils.toArray("book paragraph31 " + QUERY_TEXT, "book paragraph32", "book paragraph33"));
    ...
    public void test33_AddBooks_Exception() throws Exception {
    ...
    public void test51_UpdateBook_Exception() throws Exception {
        Book book = createBook("name", "author", "isbn", ArrayUtils.toArray("introduction"), ArrayUtils.toArray("pragraphs"));
    ...
    public void test6_SearchBook_Success() throws Exception {
        ...
        List<Book> booksHaveQueryTextList = Arrays.stream(books).filter(b ->
     ...
     * @return
     */
    private static Book createBook(String name, String author, String isbn, String[] introduction, String[] paragraphs) {
        Book book = new Book();
        book.setName(name);
